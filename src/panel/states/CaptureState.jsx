...
export default function CaptureState({ videoRef, durationMs = CAPTURE_DURATION_MS }) {
  ...
  return (
    <div className="flex flex-col h-full animate-fadein">
      ...
      <div className="w-full flex-1 min-h-0 rounded-[14px] border border-teal shadow-[0_0_0_4px_var(--color-teal-soft)] relative mb-4 flex items-center justify-center overflow-hidden bg-[#12161A]">
        <video
          ref={videoRef}
          muted
          playsInline
      ...
      <p className="text-[13px] leading-relaxed text-fog shrink-0">
